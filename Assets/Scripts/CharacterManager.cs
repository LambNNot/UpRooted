...
public class CharacterManager : MonoBehaviour
{
    ...
    public void NextOption() // this will be for the next button, to look through the playable characters
    {
        ...
        if(selectedOption >= characterD.CharacterCount) //if no more characters after the count, will return to the first one
        {
            selectedOption = 0;
        }
    ...
    public void BackOption() //this will just go in reverse of the NextOption func
    {
        selectedOption--;
    ...
    {
        Save(); //will save the character that the player chose
